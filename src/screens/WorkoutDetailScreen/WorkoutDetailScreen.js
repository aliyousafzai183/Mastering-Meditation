...
const WorkoutDetailScreen = (props) => {
  ...
  const WorkoutDetailStyles = useMemo(() => WorkoutDetailStyle(colorsset), [colorsset]);
        ...
        <View style={WorkoutDetailStyles.viewImageBoxChallengeInnerView}>
          <View>
            ...
            <View style={WorkoutDetailStyles.leftArrowView}>
              ...
              <Text style={[WorkoutDetailStyles.ImageTitle]}>Breathing Practices</Text>
            </View>
          </View>
          <View style={WorkoutDetailStyles.centerMainView}>
            ...
            <Text style={[WorkoutDetailStyles.boxText]}>Breathing Practices</Text>
            <Spacing space={SH(10)} />
            <Text style={[WorkoutDetailStyles.boxTextLight]}>For relaxation</Text>
            <Spacing space={SH(40)} />
          ...
          <View style={WorkoutDetailStyles.workoutListMainView}>
            <Button title={"Explore similar"} onPress={() => navigation.navigate(RouteName.HOME_SCREEN)} />
            <Spacing space={SH(20)} />
